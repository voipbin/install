...
def run_pre_apply_checks(
    ...
    # PR-E: cloudsql_private_ip preflight relocated to scripts/pipeline.py::_run_k8s_apply
    # (runs AFTER reconcile_outputs auto-populates the field from Terraform output).
    # Running it here would reject the sentinel before terraform_apply ever ran,
    # making fresh install impossible.
